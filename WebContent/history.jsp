	...
	<form>
		<div style="overflow-x: auto;">
			<table border="2">
				...
				<%
						List<Hist> bean = (List<Hist>)request.getAttribute("History");
						ListIterator<Hist> itr = bean.listIterator();
						while(itr.hasNext()) {
							Hist histObject = (Hist)itr.next();
				%>
				<tr>
                       <td><% out.print(histObject.getIdhistory()); %> </td>
                       <td><% out.print(histObject.getPlaces()); %></td>
                       <td><% out.print(histObject.getDate()); %></td>
                </tr>
                <%
						}
				%>
